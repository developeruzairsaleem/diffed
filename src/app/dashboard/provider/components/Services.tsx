          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {gamesData.map((game, index) => (
              <div
                ...
                className={`shadow-lg relative group cursor-pointer rounded-xl transition-all duration-300 transform hover:scale-105 ${
            ...
            <div>
              ...
              >
                ...
                >
                  {" "}
                  {/* middle card */}{" "}
                  <div className="rounded-lg  bg-black/20 shadow-2xl">
                    <div className="">
                      <div className="flex flex-wrap gap-2 p-2 rounded-lg border border-white/20">
              ...
              {selectedPackages.packages[activePackageIndex] && (
                <div
                  className="col-span-2 mb-14 lg:mb-0 shadow-lg"
                  style={{
                    borderRadius: "16px",
