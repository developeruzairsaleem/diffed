      ...
      <div className="flex flex-wrap px-[20px] justify-center items-center gap-[65px] ">
        ...
        {gameCards.map((card, index) => (
          <Link
            key={index}
            href={card.link}
            className="max-w-[368px] flex flex-col border-[1px] border-white/20 rounded-lg px-[18px] pt-[20px] pb-[21px] backdrop-blur-[50px] shadow-[0_4px_20px_-1px_rgba(0,0,0,0)] bg-white/5 capitalize transition-transform hover:scale-105"
